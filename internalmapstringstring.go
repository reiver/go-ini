...
func (receiver internalMapStringString) AppendINIContent(p []byte, nesting ...string) ([]byte, error) {
	if receiver.IsEmpty() {
		return p, nil
	}
...
func (receiver internalMapStringString) ForEachKeyMapValue(fn func(string,internalMapWrapper)error) error {
	return nil
}
